...
const product = {"repo":"SubnetPilot","suite":"Cybersecurity Suite","category":"Network planning","audience":"network engineers, cloud teams, and security architects","promise":"turn messy IP space into clean, secure, auditable network plans","inputLabel":"Network goal or CIDR block","placeholder":"Design segmented VPC for prod, staging, data, and admin access","primary":"Plan subnet","gradient":"from-sky-300 via-indigo-300 to-violet-400","metrics":["CIDR planner","Policy matrix","Cloud-ready"],"modules":["CIDR segmentation","Firewall intent map","Blast-radius labels","Capacity forecast","Change-review summary"],"outputs":["Proposed subnet table","Security zones","Routing notes","Change risk warnings"],"pricing":"$29/month Builder, $149/month Infrastructure Team, enterprise architecture review add-on."} as const;
